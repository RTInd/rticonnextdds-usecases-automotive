    ...
    DDS_Long count)
{
    ...
    {
        printf("failed to assert remote subscription(stimAndPrint_dp::StatusTopic)\n");
        goto done;
    }
    ...
    */
    ...
    if (retcode != DDS_RETCODE_OK)
    {
        printf("failed to assert remote publication(stimAndPrint_dp::MapData)\n");
        goto done;
    }
    ...
    if (retcode != DDS_RETCODE_OK)
    {
        printf("failed to assert remote publication(localization_dp::Pose3D)\n");
        goto done;
    }
